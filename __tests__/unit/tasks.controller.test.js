...
const tasks_controller_1 = require("../../src/tasks/tasks.controller");
describe('Task Controller - Unit Tests', () => {
    ...
    beforeEach(() => {
        ...
        taskController = new tasks_controller_1.TaskController(mockTaskService);
        mockJson = jest.fn();
    ...
    describe('toggleTaskCompletion', () => {
        it('should toggle task completion successfully', async () => {
            ...
            // Act
            await taskController.toggleTaskCompletion(mockReq, mockRes);
            // Assert
